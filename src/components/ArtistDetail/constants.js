...
import hebra from '../../assets/hebra.jpg'
import mancha from '../../assets/mancha.jpg'
import maniatics from '../../assets/maniatics.jpg'
import vandermou from '../../assets/vandermou.jpg'
import suspect from '../../assets/suspect.jpg'
...
export const artistsData = {
  DavidSynth:{
    name: 'David Synth',
    image: david,
    bio: 'Productor y Dj sevillano que nace en el mundo del espectáculo , hijo de una actriz y un técnico. Comienza su desarrollo artístico a la edad de 11 años, obteniendo rápidamente un reconocimiento local produciendo beats, pinchando y mezclando a grupos que a día de hoy tiene un amplio reconocimiento tanto como en la escena underground como en la escena comercial. Cuenta con mas de 15 años de producciones, grabaciones, mezclas , sesiones y conciertos a sus espaldas, siendo a día de el especialista de mezcla y mastering de algunos artistas de primer nivel nacional. Con una notable influencia del Funk ,Jazz y  se caracteriza por la mezcla de estilos en sus sesiones, plenitud de armonías y ritmos sofisticados en sus producciones llevando el genero a su lado mas conceptual y técnico, obteniendo un sonido característico y original en sus tracks, los cuales siempre destacan de forma notable en sus sets moviendo a la pista desde el primer hasta el ultimo minuto de sesión. Dichos tracks han sido pinchados por artistas de la envergadura de Misanthrop, Lockjaw ,Wreckless, BlackBarrel ademas de gran parte de la escena en España. Cabe destacar que David Synth ha compartido cartel con una infinidad de artistas, véase: Emperor, InsideInfo, Billain, Skeptical, Jade, Audio, Fourward, June Miller, Imanu (fka Signal) , Cause4Concern, Black Barrel ,MeanTeeth y Hypoxia entre otros..',
    socialLinks: {
